#!/usr/bin/env node
/**
 * Version bump for Asset & Liability Manager, run once per release.
 *
 ...
 * Monday itself skipped every week without a Monday release (expense-tracker
 * ran 2.0.0 to 2.0.50 across three September weeks that way).
 *
 ...
 * More → What's new. Notes are required.
 *
 * One bump covers a whole branch. When review turns up more work, add notes
 * to the version already prepared rather than cutting another one.
 *
